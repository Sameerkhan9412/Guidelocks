      ...
      <div className="container mx-auto px-4 pt-32 pb-16">
          ...
          <div className="lg:col-span-2">
           <Link href="/" className="flex items-center gap-3 group">
            ...
            <p className="text-gray-400 mb-6 max-w-sm">
              ...
              and security solutions. Protecting homes and businesses since 1998.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-gray-400">
                ...
                <span>123 Security Street, Mumbai, Maharashtra 400001</span>
              </div>
              <div className="flex items-center gap-3 text-gray-400">
        ...
        <div className="text-center pt-8 mt-8 border-t border-gray-800">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} LockShop. All rights reserved. | 
