...
const testimonials = [
  {
    ...
    rating: 5,
    text: "Vinayak International's mortise lock has been securing my home for 5 years now. The quality is exceptional, and their after-sales service is top-notch. Highly recommend!",
    videoUrl: null,
  },
  {
    name: "Sneha Kapoor",
    ...
    rating: 5,
    text: "I recommend Vinayak International to all my clients. Their locks not only provide excellent security but also complement modern interior designs beautifully.",
    videoUrl: "#",
  },
  {
    name: "Rahul Verma",
    ...
    rating: 5,
    text: "We've installed over 200 Vinayak International locks in our hotel. The durability and reliability are unmatched. Our guests feel safe, and that's what matters most.",
    videoUrl: null,
  },
  {
    name: "Priya Nair",
    ...
    rating: 5,
    text: "The smart locks from Vinayak International have revolutionized how my clients think about home security. Modern, reliable, and easy to use.",
    videoUrl: "#",
  },
  {
    name: "Vikram Singh",
    ...
    rating: 5,
    text: "As a builder, I've tried many lock brands. Vinayak International stands out for quality and price. They're my go-to for all residential projects.",
    videoUrl: null,
  },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Real stories from real customers who trust Vinayak International for their security needs
          </p>
        </motion.div>
